...
## [0.14.0](https://github.com/jostled-org/palette-core/compare/v0.13.0...v0.14.0) - 2026-04-08

### Added

- [**breaking**] add gradient support with OKLab/OKLCH interpolation

## [0.13.0](https://github.com/jostled-org/palette-core/compare/v0.12.3...v0.13.0) - 2026-04-08

### Added

- [**breaking**] add syntect theme generation, update egui to 0.34

## [0.12.3](https://github.com/jostled-org/palette-core/compare/v0.12.2...v0.12.3) - 2026-04-07
...
## [0.12.2](https://github.com/jostled-org/palette-core/compare/v0.12.1...v0.12.2) - 2026-03-24

### Other

- unify terminal macros and tighten guide voice

## [0.12.1](https://github.com/jostled-org/palette-core/compare/v0.12.0...v0.12.1) - 2026-03-24

### Other

- *(wasm)* remove unnecessary doc comments

## [0.12.0](https://github.com/jostled-org/palette-core/compare/v0.11.0...v0.12.0) - 2026-03-22

### Added

- [**breaking**] add is_light theme classification

## [0.11.0](https://github.com/jostled-org/palette-core/compare/v0.10.0...v0.11.0) - 2026-03-21

### Other

- [**breaking**] third audit pass — perf, validation, restore style helper

## [0.10.0](https://github.com/jostled-org/palette-core/compare/v0.9.0...v0.10.0) - 2026-03-21

### Other

- [**breaking**] second audit pass — perf, DRY, Arc-wrap meta types

## [0.9.0](https://github.com/jostled-org/palette-core/compare/v0.8.6...v0.9.0) - 2026-03-21

### Fixed

- remove stale style import and test from terminal tests

### Other

- fix formatting in terminal tests
- [**breaking**] audit remediation — ownership, naming, DRY, dead code

## [0.8.6](https://github.com/jostled-org/palette-core/compare/v0.8.5...v0.8.6) - 2026-03-13

### Other

- Update README.md

## [0.8.5](https://github.com/jostled-org/palette-core/compare/v0.8.4...v0.8.5) - 2026-03-13

### Other

- link to p3-demo repository in README

## [0.8.4](https://github.com/jostled-org/palette-core/compare/v0.8.3...v0.8.4) - 2026-03-13

### Other

- add resolve_with_contrast and nudge_foreground usage examples

## [0.8.3](https://github.com/jostled-org/palette-core/compare/v0.8.2...v0.8.3) - 2026-03-13

### Added

- *(contrast)* add resolve_with_contrast to auto-fix WCAG violations

## [0.8.2](https://github.com/jostled-org/palette-core/compare/v0.8.1...v0.8.2) - 2026-03-12

### Other

- skip expensive jobs on doc-only changes
